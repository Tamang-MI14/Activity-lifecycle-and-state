...
public class Second_Activity extends AppCompatActivity {
    public static final String EXTRA_ITEMS = "me.tamang.shoppinglist.extra.ITEMS";
    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.button_salt:
                ...
                break;
            default:
                Toast.makeText(Second_Activity.this, "There was an error", Toast.LENGTH_LONG).show();
                break;
